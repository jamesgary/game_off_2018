...
{-| From <https://github.com/zaidan/elm-collision/blob/1.0.1/src/Collision.elm> at elm version 0.18
I'm too lazy to make/find a new package.
...
collision limit minkA minkB =
    let
        ...
        maybec =
            calcMinkSupport minkA minkB d1

        maybeb =
            calcMinkSupport minkA minkB d2
    in
...
collision2 limit minkA minkB c b =
    let
        ...
        d =
            getDirectionVector cb c0

        simplexResult =
            doSimplex limit 0 minkA minkB ( [ b, c ], d )
    in
